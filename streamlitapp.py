...
if options: 
    ...
    with col2: 
        ...
        # Convert frames to the correct data type and normalize
        frames = np.squeeze(video)
...
#streamlit run /Users/phanindrasai/Desktop/final_lipread/app/streamlitapp.py